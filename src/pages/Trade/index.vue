  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="detailArray in orderData.detailArrayList"
        ...
        >
          ...
          <li>
            <p class="pHidden" :title="detailArray.skuName">
              {{ detailArray.skuName }}
            </p>
            <h4>7天无理由退货</h4>
          </li>
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b
            ><i>{{ orderData.totalNum }}</i
            >件商品，总商品金额</b
          >
          <span>¥{{ orderData.originalTotalAmount }}.00</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
    ...
    <div class="trade">
      <div class="price">
        应付金额:　<span>¥{{ orderData.originalTotalAmount }}.00</span>
      </div>
...
export default {
  ...
  computed: {
    ...mapState("trade", ["userAddress", "orderData"]),
    userDefaultAddress() {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        orderDetailList: this.orderData.detailArrayList,
      };
      let result = await this.$API.reqSubmitOrder(tradeNo, data);
      console.log(result);
      if (result.code == 200) {
        this.payCode = result.data;
        this.$router.push("/pay?paycode=" + this.payCode);
      } else {
